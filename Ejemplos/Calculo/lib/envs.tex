...
\newenvironment{proof}[1][\textbf{\textit{Demostración}}]{
    \par\medskip\noindent \textcolor{rojo1}{#1.}
    \rmfamily
}{
    $\hfill\textcolor{rojo1}{\blacksquare}$\\
    \medskip
}
...
\newenvironment{problem}[1][\theproblem]{
    \begin{tcolorbox}[colback=red!20,colframe=red!50,before upper={\parindent15pt},breakable]
