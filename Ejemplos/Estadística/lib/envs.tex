...
\newenvironment{proof}[1][\textbf{\textit{Demostración}}]{
     \par\medskip\noindent \textcolor[rgb]{0.8,0.2,0.1}{#1.}
     \rmfamily
}{
    \par
    % $\hfill\textcolor[rgb]{0.2,0,0.6}{\textbf{QED}}$\\
    $\hfill\textcolor[rgb]{0.8,0.2,0.1}{\blacksquare}$\\
}
...
\newenvironment{solution}[1][\textbf{\textit{Solución}}]{
    ...
    $\hfill\textcolor[rgb]{0.8,0.2,0.1}{\square}$\\
}
...
\newenvironment{problem}[1][\theproblem]{
    \begin{tcolorbox}[colback=orange!20,colframe=orange!50]
