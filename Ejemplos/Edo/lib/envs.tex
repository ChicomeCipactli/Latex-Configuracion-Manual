...
\newenvironment{proof}[1][\textbf{\textit{Demostración}}]{
     \par\medskip\noindent \textcolor[rgb]{0.1,0.5,0.1}{#1.}
     \rmfamily
}{
    \par
    % $\hfill\textcolor[rgb]{0.2,0,0.6}{\textbf{QED}}$\\
    $\hfill\textcolor[rgb]{0,0.4,0}{\blacksquare}$\\
}

\newenvironment{solution}[1][\textbf{\textit{Solución}}]{
     \par\medskip\noindent \textcolor[rgb]{0,0.4,0}{#1.}
     \rmfamily
}{
    \par
    % $\hfill\textcolor[rgb]{0.2,0,0.6}{\textbf{S}}$\\
    $\hfill\textcolor[rgb]{0,0.4,0}{\square}$\\
}
...
\newenvironment{problem}[1][\theproblem]{
    \begin{tcolorbox}[colback=green!20,colframe=green!50]
